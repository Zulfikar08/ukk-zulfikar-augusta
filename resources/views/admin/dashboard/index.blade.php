                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Zulfikar Augusta</span>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Progress Tanggapan
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Zulfikar Augusta - Masyarkat</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <p>
                                        Selamat siang bapak/ibu yang terhormat! Saya selaku anggota karang taruna
                                        Desa Cibogo kecamatan Cibogo, Kabupaten Subang. ingin menyampaikan tanggapan
                                        saya mengenai jalanan yang rusak di daerah Subang baru residence. Berikut foto
                                        yang saya cantumkan
                                    </p>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nikola - Admin</h6>
                                </div>
                                <div class="card-body">

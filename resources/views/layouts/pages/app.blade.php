...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('datatable/css/responsive.dataTables.min.css') }}">
...
<body>
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="{{ url('icon/envelope-user.png') }}">
                                    </span>
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg">
                    <div class="copyright text-center text-lg-left text-muted">
                        Copyright &copy; 2021<a href="https://www.creative-tim.com" class="font-weight-bold ml-1"
                            target="_blank">Envelope</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script type="text/javascript" language="javascript" src="{{ url('datatable/js/jquery.dataTables.min.js') }} ">
    </script>
    <script type="text/javascript" language="javascript" src="{{ url('datatable/js/dataTables.bootstrap4.min.js') }} ">
    </script>
    <script type="text/javascript" language="javascript" src="{{ url('datatable/js/dataTables.responsive.min.js') }} ">
    </script>
